...
class AstRenderer(BaseRenderer):
    ...
    def link(self, link, children=None, title=None, span = None):
        return {
            'type': 'link',
            'link': link,
            'children': children,
    ...
    def heading(self, children, level, span = None):
        return {'type': 'heading', 'children': children, 'level': level, "span" : {"from": span["from"], "to":span["to"]} if span else {}}
    ...
    def _create_default_method(self, name):
        def __ast(children, span = None):
            return {'type': name, 'children': children, "span":span}
        return __ast
